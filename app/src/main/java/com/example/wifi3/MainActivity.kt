...
import com.example.wifi3.ui.DataReceiverThread
import com.example.wifi3.ui.DataReceiverThread.DataReceivedListener
...
class MainActivity : AppCompatActivity(),DataReceivedListener{
    ...
    companion object {
        const val SERVER_IP = "192.168.57.147"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        wifiConnectionSwitch.isClickable =false
...
//                        out.close()
    ...
    private fun makeButtonDisable() {
        arduinoConnectionSwitch.isEnabled = false
        sendDataButton.isEnabled = false
    }
    private fun makeButtonEnable() {
        arduinoConnectionSwitch.isEnabled = true
...
//                socket = Socket(serverAddress, SERVER_PORT)
                ...
                DataReceiverThread(socket, this@MainActivity).start()
